...
% Dies ist legacy-Code und nur enthalten um sicher zu stellen,
% dass alte Folien, die noch diese koordinatensysteme und nicht
% cartesiangrid aus xpicture verwenden kompiliert werden können.:w
