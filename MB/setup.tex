...
% ---------------------------------------------------------------------
\typeout{Einstellung für Texte auf report/book-Basis}
...
\includegraphics[width=0.8\textwidth]{\imagePath/Misc/buchicon}%
\end{minipage}%
...
\includegraphics[width=\textwidth]{\imagePath/Misc/reading}%
\end{minipage}%
...
%
% Smile Face
\newcommand{\smileface}[0]{\randnotiz{\includegraphics[width=1cm]{\imagePath/Misc/Face-smile}}}
%
...
%
\newcommand{\titelseite}[2][\titleImage]{%
%% Titelseite
\pagenumbering{roman}%
\thispagestyle{empty}%
\begin{titlepage}%
