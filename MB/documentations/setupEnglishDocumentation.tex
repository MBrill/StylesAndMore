...
\input{stammdatenEnglish}
% Einstellungen
\input{setup_english}
% Daten zur Lehrveranstaltung
\input{LVDefinitionenEnglish}
%
% bibgerm, da deutsche Einträge in bib-Datei.
% Falls hier englische Einträge verwendet werden
% kann diese Zeile kommentiert werden.
\usepackage{bibgerm}
%
\input{pdfsetupEnglish}
%
...
More on \LaTeX{} can be found in\cite{mittelbach_05} und \cite{kopka_02} (sorry for the german references.

Tests are done on Windows 10 and MiKTeX 22.3. The german versions are also tested on a Debian distribution.
It is known that students also use this files on a Mac.
%
%
%
\input{packstyleEnglish}
%
%
% Literatur
%
...
\sectionmark{Bibliography}\label{literatur}
\bibliography{latex}
%
% Anhang
%
