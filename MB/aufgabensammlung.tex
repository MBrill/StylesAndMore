% -----------------------------------------------------------------
% Einstellungen für Sammlungen von Aufgaben
% Verwendet die Einstellung in übungsaufgaben.tex
% Die Ausgabe der Aufgabennummer wird durch
% eine Box ergänzt, die den Dateinamen anzeigt.
%
% Zwei weitere Variable werden definiert,
% für die Indizierung von Klausuraufgaben und
% die Verwendung von Aufgaben in Übungsblättern.
% ---------------------------------------------------------------
\typeout{Einstellungen für Aufgabensammlungen}
\typeout{     (C) Manfred Brill}
\typeout{     Version 1.1 Februar 2018}
% Variable für die Übungsblatt-Nummer
\newcommand{\theBlatt}{Aufgabensammlung}
% Die Einstellung für Übungsblätter laden
...
% aufgabe überschreiben, Dateiname mit ausgeben
\renewcommand{\aufgabe}[1]{\setcounter{equation}{0}\filename{#1.tex}\aufgabentext{#1}\solaufgabe{#1}}

% Funktion für das Verzeichnis der in einer Klausur verwendeten Aufgaben
\newcommand{\klausur}[1]{\ref{#1}&\lstinline$#1$}
%
% Funktion für das Verzeichnis der in den Übungsblättern verwendeten Aufgaben
...
% Die Kurzbezeichnungen werden mit addcontentsline dem Inhaltsverzeichnis hinzugefügt
